...
const Page2 = () => {
  ...
  return (
    <div id="page2" className="bg-white text-center text-black pt-[2vw]">
      <h4 className="text-[1.5vw] mb-[5vw] font-normal text-zinc-500 font-[font3]">©  anzo.studio 2024 | designed and developed</h4>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">IMPACTFUL</h1>
      </div>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">DESIGN</h1>
      </div>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">IS THE</h1>
      </div>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">DESIGN</h1>
      </div>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">THAT</h1>
      </div>
      <div>
        <h1 className="rotateText text-[40vw] leading-[32vw] font-[font7] font-bold">WORKS</h1>
      </div>
      <div className="w-[100%] flex items-center justify-center scale-75">
      ...
      <div className="h-[1px] rounded-lg mb-[3vw] w-[35%] bg-black relative left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
    </div>
  )
}
